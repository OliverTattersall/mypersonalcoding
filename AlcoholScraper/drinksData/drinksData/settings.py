"""
Django settings for drinksData project.
...
SECRET_KEY = 'django-insecure-1vz-pur+de&fip)g(%c%re@e_xi$wl5kbw-j-1j#cdd&c=!^1u'
...
WSGI_APPLICATION = 'drinksData.wsgi.application'
